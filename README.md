...
The app creates a default InfluxDB database called `jmeter` and `telegraf`.

## Data Sources

The app creates a Grafana data source called `jmeter` and `telegraf` that's connected to the IndfluxDB database `jmeter` and `telegraf`.
